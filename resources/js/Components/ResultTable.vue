...
<template>
    ...
    <table class="table-auto w-full text-left whitespace-no-wrap">
        ...
        <tbody>
            <tr v-for="rfm in data.eachCount" :key="rfm.Rank">
                ...
                <td class="border-b-2 border-gray-200 px-4 py-3">{{ rfm.v }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table-auto w-full text-left whitespace-no-wrap">
        <thead>
            <tr>
                <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl">rRnak</th>
